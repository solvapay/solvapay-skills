...
4. Verify usage and purchases appear in dashboard.
...
- [ ] Usage and purchase records are visible in dashboard
...
- Dashboard usage missing -> verify usage event recording path and environment mode.
